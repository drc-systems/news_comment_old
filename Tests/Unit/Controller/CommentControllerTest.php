...
/**
 * Test case for class DRCSystems\NewsComment\Controller\CommentController.
 *
 */
class CommentControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \DRCSystems\NewsComment\Controller\CommentController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('DRCSystems\\NewsComment\\Controller\\CommentController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCommentsFromRepositoryAndAssignsThemToView()
	{
		...
		$commentRepository = $this->getMock('DRCSystems\\NewsComment\\Domain\\Repository\\CommentRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$comment = new \DRCSystems\NewsComment\Domain\Model\Comment();
	...
	public function createActionAddsTheGivenCommentToCommentRepository()
	{
		...
		$commentRepository = $this->getMock('DRCSystems\\NewsComment\\Domain\\Repository\\CommentRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenCommentInCommentRepository()
	{
		...
		$commentRepository = $this->getMock('DRCSystems\\NewsComment\\Domain\\Repository\\CommentRepository', array('update'), array(), '', FALSE);
		$commentRepository->expects($this->once())->method('update')->with($comment);
		$this->inject($this->subject, 'commentRepository', $commentRepository);
	...
	public function deleteActionRemovesTheGivenCommentFromCommentRepository()
	{
		...
		$commentRepository = $this->getMock('DRCSystems\\NewsComment\\Domain\\Repository\\CommentRepository', array('remove'), array(), '', FALSE);
		$commentRepository->expects($this->once())->method('remove')->with($comment);
		$this->inject($this->subject, 'commentRepository', $commentRepository);
