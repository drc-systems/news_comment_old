# -*- coding: utf-8 -*-
#
# news comment documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 30 Sep 2016 10:41:22 +0530.
#
...
project = u'news comment'
copyright = u'2016, Rajen'
...
htmlhelp_basename = 'newscommentdoc'
...
latex_documents = [
    ('Index', 'newscomment.tex', u'news comment',
     u'Rajen', 'manual'),
]
...
pdf_documents = [
    ('Index', 'newscomment', u'news comment',
     u'Rajen'),
]
...
texinfo_documents = [
    ('Index', 'newscomment', u'news comment',
     u'Rajen', 'news comment', 'One line description of project.',
     'Miscellaneous'),
]
